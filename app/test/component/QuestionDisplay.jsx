      ...
      <div>
        ...
        <div className="mt-4">
          ...
          {questionData.options.map((option, index) => (
            <div 
              key={index} 
              className="flex items-center mt-2 border rounded-lg p-2 cursor-pointer"
              onClick={() => onAnswerSelect(option.id)}
            >
              <div className={`w-6 h-6 rounded-full flex items-center justify-center mr-2 border ${
                currentAnswer === option.id ? "border-4 border-blue-500" : "border-gray-300"
              }`}>
